...
sed -i 's/&CF_DB_USERNAME/${DBUsername}/g' ${DB_PROV_SCRIPT_PATH}
sed -i 's/&CF_DB_PASSWORD/${DBPassword}/g' ${DB_PROV_SCRIPT_PATH}
sed -i 's/&CF_DB_HOST/${DBHost}/g' ${DB_PROV_SCRIPT_PATH}
sed -i 's/&CF_DB_PORT/${DBPort}/g' ${DB_PROV_SCRIPT_PATH}
sed -i 's/&CF_DB_NAME/${DBEngine}/g' ${DB_PROV_SCRIPT_PATH}
sed -i 's/&CF_DB_VERSION/${DBEngineVersion}/g' ${DB_PROV_SCRIPT_PATH}
sed -i 's/&PRODUCT_VERSION/${WSO2_PRODUCT_VERSION}/g' ${DB_PROV_SCRIPT_PATH}

bash ${DB_PROV_SCRIPT_PATH}