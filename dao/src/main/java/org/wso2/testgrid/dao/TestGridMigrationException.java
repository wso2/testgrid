...
/**
 * Indicates an error occurred when generating reports.
 *
 * @since 1.0.0
 */
public class TestGridMigrationException extends Exception {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause(Throwable)}.
     */
    public TestGridMigrationException() {
        super();
    }
     ...
     */
    public TestGridMigrationException(String message) {
        super(message);
    }
     ...
     */
    public TestGridMigrationException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public TestGridMigrationException(String message, Throwable cause) {
        super(message, cause);
    }
}
