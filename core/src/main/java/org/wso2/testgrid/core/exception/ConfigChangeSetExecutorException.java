...
/**
 * Represents the custom exceptions class to hold exceptions related to config change set execution.
 */
public class ConfigChangeSetExecutorException extends Exception {
     ...
     */
    public ConfigChangeSetExecutorException(String message) {
        super(message);
    }
     ...
     */
    public ConfigChangeSetExecutorException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public ConfigChangeSetExecutorException(String message, Throwable cause) {
        super(message, cause);
    }
}
