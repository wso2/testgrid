...
public class UnsupportedDeployerException extends Exception {
    ...
    public UnsupportedDeployerException(String msg, Exception nestedEx) {
        super(msg, nestedEx);
    }

    public UnsupportedDeployerException(String message, Throwable cause) {
        super(message, cause);
    }

    public UnsupportedDeployerException(String msg) {
        super(msg);
    }
    ...
    public UnsupportedDeployerException(Throwable cause) {
        super(cause);
    }
}
