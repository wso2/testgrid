...
public class TestGridConstants {
    ...
    public static final String KUBERNETES_GROOVY_HELPER = "kubedeployment_editor.groovy";
    ...
    public static final String HELM_DECORATOR_FILE = "helm_flag_explicit_in_mem";
