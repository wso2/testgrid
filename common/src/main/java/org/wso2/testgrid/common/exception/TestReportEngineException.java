 ...
 * @since 1.0.0
 */
public class TestReportEngineException extends Exception {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause(Throwable)}.
     */
    public TestReportEngineException() {
        super();
    }
     ...
     */
    public TestReportEngineException(String message) {
        super(message);
    }
     ...
     */
    public TestReportEngineException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public TestReportEngineException(String message, Throwable cause) {
        super(message, cause);
    }
}
