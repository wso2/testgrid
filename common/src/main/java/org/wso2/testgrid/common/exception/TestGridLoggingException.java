...
public class TestGridLoggingException extends Exception {
     ...
     */
    public TestGridLoggingException(String message) {
        super(message);
    }
     ...
     */
    public TestGridLoggingException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public TestGridLoggingException(String message, Throwable cause) {
        super(message, cause);
    }
}
