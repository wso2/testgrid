...
/**
 * This is a custom exception class to throw all runtime issues related to TestGrid. This will also be visible to
 * external callers.
 */
public class TestGridRuntimeException extends RuntimeException {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause(Throwable)}.
     */
    public TestGridRuntimeException() {
        super();
    }
     ...
     */
    public TestGridRuntimeException(String message) {
        super(message);
    }
     ...
     */
    public TestGridRuntimeException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public TestGridRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }
}
